...
### Lagomorph Web (Recommended for New Users)

The fastest way to start morphing. No downloads, no installs, no account needed, just open your browser and go.

[Open app.lagomorph.ai](https://app.lagomorph.ai){: .btn .btn-primary }

1. Open [app.lagomorph.ai](https://app.lagomorph.ai)
...
See the full [guide](web) for details.
...
[Download from GitHub](https://github.com/LagomorphAI/unity-engine-plugin-release){: .btn }

1. Download from GitHub or the [Fab store](https://www.fab.com/)
...
See the full [Unity Plugin Guide](unity) for detailed installation and usage.
...
[Download from GitHub](https://github.com/LagomorphAI/unreal-engine-plugin-release){: .btn }
...
See the full [Unreal Engine Plugin Guide](unreal) for detailed installation and usage.
...
Want to be notified when these are available? Join our [Discord](https://discord.gg/RsNwwy3WCc) or email us at [hello@lagomorph.ai](mailto:hello@lagomorph.ai).
